                            ...
                            <div class="col-lg-10">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h2 text-primary">Login</h1>
                                        <p class="h5 text-gray-900 mb-4">Enter your login details and click on the login button</p>
                                    </div>
                                    <form class="user" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control form-control-user @error('email')
                                                is-invalid
                                            @enderror" type="email" name="email" :value="old('email')" id="email" autofocus autocomplete="username"> <br>
                                            @error('email')
                                        ...
                                        <div class="form-group">
                                            <input class="form-control form-control-user @error('password')
                                                is-invalid
                                            @enderror" type="password" id="password"
                                            name="password"
